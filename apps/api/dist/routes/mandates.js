...
const issueMandateSchema = zod_1.z.object({
    ...
    market: zod_1.z.string().min(3).max(40).optional(),
    maxNotionalPerDay: zod_1.z.string().optional(),
    quoteDecimals: zod_1.z.number().int().min(0).max(18).optional(),
...
router.post("/agents/:agentId", auth_1.requireUser, (0, require_auth_1.requireRecentMfa)(), (0, require_auth_1.requireLiveModeEligible)(), (0, audit_privileged_1.auditPrivilegedRequest)("MANDATE_ISSUE_REQUESTED", "MANDATE", (req) => String(req.params.agentId)), async (req, res) => {
...
router.post("/:mandateId/revoke", auth_1.requireUser, (0, require_auth_1.requireRecentMfa)(), (0, audit_privileged_1.auditPrivilegedRequest)("MANDATE_REVOKE_REQUESTED", "MANDATE", (req) => String(req.params.mandateId)), async (req, res) => {
